           ...
           <ul class="navbar-nav me-auto mb-2 mb-lg-0">
             ...
             <li class="nav-item dropdown">
               ...
               <ul class="dropdown-menu active " aria-labelledby="navbarDropdown">
                 ...
                 <li><a class="dropdown-item" href="#">Minor project </a></li>
                 <li>
             ...
             <li class="nav-item">
               <a class="nav-link disabled" href="Future.php" tabindex="-1" aria-disabled="true">Future Goal</a>
             </li>
           </ul>
           <form1 class="d-flex" action="https://www.google.com/" target="blanck" method="GET">
                     ...
                     <div class="py-5">
                            ...
                            <div class="w-50 m-auto">
                                   <form action="userinfo.php" method="post">
                                          ...
                                          <div class="form-group">
                                                 <label>Mobile</label>
                                                 <input type="text" name="mobile" class="from-control">
       ...
       <footer>
              <div class="container">
                     <div class=" sec aboutus">
                            ...
                            <ul class="sci">
                                   <li><a href="https://www.facebook.com/profile.php?id=100010439765590"><i
                                                        class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                                   <li><a href="https://twitter.com/amit_10111"><i class="fab fa-twitter"
                                                        aria-hidden="true"></i></i></a></li>
                                   <li><a href="www.linkedin.com/in/amit-mishra-4579b91b5"><i class="fab fa-linkedin-in"
                     ...
                     <div class="Quicklinks">
                            <h2>QuickLinks<h2>
                                          <ul>
                                                 ...
                                                 <li><a href="https://www.georgecollege.org/george-college-of-management-and-science">Collage</a>
                                                 </li>
